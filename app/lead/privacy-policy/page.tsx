      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="text-sm text-white/70 space-y-6">
          ...
          <section>
            ...
            <p>You must be at least 18 years old to use this service. Our vehicle rental services require renters to be 25 years or older with a valid driver&apos;s license and insurance. We do not knowingly collect information from individuals under 18.</p>
          </section>
