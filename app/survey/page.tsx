          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              <a href="/" className="relative group">
                <Image src="/velocitylogo.png" alt="Scale Exotics" width={140} height={28} className="h-7 w-auto" priority />
      ...
      <footer className="relative py-6 md:py-8 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
            <Image src="/velocitylogo.png" alt="Scale Exotics" width={100} height={20} className="h-4 md:h-5 w-auto opacity-40" loading="lazy" />
