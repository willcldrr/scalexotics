    ...
    return (
      <div className="relative w-full h-full bg-[#06060a] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 px-10 pt-10 flex items-center justify-between">
          <Image src="/velocitylogo.png" alt="Scale Exotics" width={52} height={52} className="w-13 h-13 object-contain" />
    ...
    return (
      <div className="relative w-full h-full bg-[#06060a] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 px-8 pl-14 pt-12">
          <Image src="/velocitylogo.png" alt="Scale Exotics" width={44} height={44} className="w-11 h-11 object-contain opacity-70" />
        </div>
  ...
  if (card.type === "cta") {
    return (
      <div className="relative w-full h-full bg-[#06060a] flex flex-col overflow-hidden">
        ...
        {/* Header */}
        <div className="relative z-10 px-8 pl-14 pt-12">
          <Image src="/velocitylogo.png" alt="Scale Exotics" width={44} height={44} className="w-11 h-11 object-contain opacity-80" />
        </div>
