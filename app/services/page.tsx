    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed animate-fade-in font-light" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="space-y-8">
            {[
              ...
              >
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center p-8 md:p-12 rounded-3xl border border-white/[0.06] bg-white/[0.02] hover:border-[#375DEE]/30 transition-colors duration-500">
                  {/* Content */}
                  <div className={`${i % 2 === 1 ? "lg:order-2" : ""}`}>
                    <div className="flex items-center gap-4 mb-6">
                      <span className="text-sm text-[#375DEE] tracking-widest">{service.num}</span>
                      <div className="h-px flex-1 bg-gradient-to-r from-[#375DEE]/50 to-transparent" />
                    </div>
                    <div className="w-16 h-16 rounded-2xl bg-[#375DEE]/10 border border-[#375DEE]/30 flex items-center justify-center text-[#375DEE] mb-6 group-hover:bg-[#375DEE]/20 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {service.features.map((feature) => (
                        <div key={feature} className="flex items-center gap-3">
                          <div className="w-5 h-5 rounded-full bg-[#375DEE]/20 flex items-center justify-center flex-shrink-0">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible("process") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            <span className="text-[#375DEE] text-sm tracking-widest uppercase mb-4 block">How It Works</span>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-6xl font-bold text-white/[0.03] absolute -top-4 left-0" style={{ fontFamily: 'var(--font-display)' }}>
                  {step.num}
                </div>
                <div className="relative pt-8">
                  <div className="w-10 h-10 rounded-full bg-[#375DEE] flex items-center justify-center text-white font-bold mb-4" style={{ fontFamily: 'var(--font-display)' }}>
                    {step.num}
                  </div>
